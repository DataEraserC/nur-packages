...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  PiliPalaX = {
    pname = "PiliPalaX";
    version = "b043dc38c4c163bb68445cf6896f47179fed5246";
    src = fetchFromGitHub {
      owner = "bggRGjQaUbCoE";
      repo = "PiliPlus";
      rev = "b043dc38c4c163bb68445cf6896f47179fed5246";
      fetchSubmodules = true;
      hash = "sha256-4lwcCok6Piot8/Mt9cpjGyhp9u9SgC5pK8wsNZ8f0bI=";
    };
    date = "2025-09-17";
  };
  SteamTools = {
  ...
  cachyos-kernel = {
    ...
    version = "d7c553d822d9ce8e64c18411add1a57befe5f3ea";
    src = fetchFromGitHub {
      owner = "CachyOS";
      repo = "linux-cachyos";
      rev = "d7c553d822d9ce8e64c18411add1a57befe5f3ea";
      hash = "sha256-YW1XPnYwQHiaaCByD5abEGRot29UptAwjfodteA2dbs=";
    };
    date = "2025-09-15";
  };
  ...
  v2ray-rules-dat = {
    ...
    src = fetchurl {
      url = "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/download/202509162211/rules.zip";
      hash = "sha256-ZLcF6k/1OEMPsUYuQTiNoXLNPS3ijHAcPNIUS7JDee0=";
    };
  };
