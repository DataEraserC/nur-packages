...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  escrcpy_appimage = {
    ...
    version = "1.32.0";
    src = fetchurl {
      url = "https://github.com/viarotel-org/escrcpy/releases/download/v1.32.0/Escrcpy-1.32.0-linux-x86_64.AppImage";
      hash = "sha256-PDWIyWZj5IvM3b+Nb82ExiDebZ4FA/QWZGwUdELqwzI=";
    };
  };
  etherguard = {
    pname = "etherguard";
  ...
  geolite2-asn = {
    ...
    src = fetchurl {
      ...
      hash = "sha256-8nHPRcJdEN4eMLw/2WwzYHbEVNSWyV3gm3iBdbsIQ/Q=";
    };
  };
  geolite2-city = {
    pname = "geolite2-city";
    ...
    src = fetchurl {
      ...
      hash = "sha256-ZdFC4UUmOR2qVyFcX9LYBsXVMDylOTI/Tug0STfL4ns=";
    };
  };
  geolite2-country = {
    ...
    src = fetchurl {
      ...
      hash = "sha256-SFTy2J8XWK6DWv5Wbew67i7/WL5n0lxVjKyDYzRl2/0=";
    };
  };
  glauth = {
    pname = "glauth";
  ...
  uni-api = {
    pname = "uni-api";
    version = "7751100d6fdead119da04d33a35a4c3eadaddb08";
    src = fetchFromGitHub {
      owner = "yym68686";
      repo = "uni-api";
      rev = "7751100d6fdead119da04d33a35a4c3eadaddb08";
      fetchSubmodules = true;
      hash = "sha256-DJo15xiiVyUxHZlwjyuBkWwFGMbT5+pXSIg/0rxvRSQ=";
    };
    date = "2025-09-07";
  };
  unigine-heaven = {
  ...
  v2ray-rules-dat = {
    ...
    src = fetchurl {
      url = "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/download/202509082213/rules.zip";
      hash = "sha256-HgXTXYr/VEalsLrL+aLp2qP2xSp05773PVgku3JelXw=";
    };
  };
