...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  AAA_flutter_server_box_appimage = {
    ...
    version = "v1.0.1276/ServerBox_1276_amd64.AppImage";
    src = fetchurl {
      url = "https://github.com/lollipopkit/flutter_server_box/releases/download/v1.0.1276/ServerBox_1276_amd64.AppImage";
      hash = "sha256-+57RG+LriMhuztIL0eNDbILEo+qZJ+BULyqOcaKuPY8=";
    };
  };
  AAA_hdrop = {
    pname = "AAA_hdrop";
  ...
  AAA_open-interpreter = {
    ...
    version = "0d19f3af83feff996ac862d74e3cc7afa17e64aa";
    src = fetchFromGitHub {
      owner = "OpenInterpreter";
      repo = "open-interpreter";
      rev = "0d19f3af83feff996ac862d74e3cc7afa17e64aa";
      fetchSubmodules = true;
      hash = "sha256-jKSjgMml/SKuZFzthUbd5VX9ITwMZGwjx7nAXfxEYJA=";
    };
    date = "2025-12-05";
  };
  AAA_rwkv = {
    ...
    version = "0.8.31";
    src = fetchurl {
      url = "https://pypi.org/packages/source/r/rwkv/rwkv-0.8.31.tar.gz";
      hash = "sha256-5IX0SQUHGtvGBu1kQ/L5EcoVX8NOFnbNRjVdhQR0UTM=";
    };
  };
  AAA_scrcpy-mask = {
  ...
  geolite2-asn = {
    ...
    src = fetchurl {
      ...
      hash = "sha256-fvDJs+DSD12IVZVBUaFzZsXMO0RdEEpQ1rY/ZmuFMm8=";
    };
  };
  geolite2-city = {
    pname = "geolite2-city";
    ...
    src = fetchurl {
      ...
      hash = "sha256-T/iCn+pFdWZ1LMmm0vzeUo8DbTBXYedw9vgImsAnF5o=";
    };
  };
  geolite2-country = {
    ...
    src = fetchurl {
      ...
      hash = "sha256-39h8qNxAitcDrO/UmgYfCyYb5wRO0/J6suHhMw4nbC8=";
    };
  };
  glauth = {
    pname = "glauth";
  ...
  qemu-user-static-amd64 = {
    ...
    version = "10.2.0+ds-1";
    src = fetchurl {
      url = "http://ftp.debian.org/debian/pool/main/q/qemu/qemu-user_10.2.0+ds-1_amd64.deb";
      name = "qemu.deb";
      hash = "sha256-6JD+NEGdCtrm3c1H8JE0db2D268uYbZW5eZdDPnCmSE=";
    };
  };
  qemu-user-static-arm64 = {
    ...
    version = "10.2.0+ds-1";
    src = fetchurl {
      url = "http://ftp.debian.org/debian/pool/main/q/qemu/qemu-user_10.2.0+ds-1_arm64.deb";
      name = "qemu.deb";
      hash = "sha256-+GwOrqauCwQBDkeZ+SUAMWx2ypQlcMt1PVakApEQQvA=";
    };
  };
  qemu-user-static-armhf = {
    ...
    version = "10.2.0+ds-1";
    src = fetchurl {
      url = "http://ftp.debian.org/debian/pool/main/q/qemu/qemu-user_10.2.0+ds-1_armhf.deb";
      name = "qemu.deb";
      hash = "sha256-wnSO2NB+hdiw3CkXiGwIX02hUg+qLQB+O7CA8VpI4Sk=";
    };
  };
  qemu-user-static-i386 = {
    ...
    version = "10.2.0+ds-1";
    src = fetchurl {
      url = "http://ftp.debian.org/debian/pool/main/q/qemu/qemu-user_10.2.0+ds-1_i386.deb";
      name = "qemu.deb";
      hash = "sha256-WD2+CgFvWoAxd9z5dxc5iHYT6DYifPgx+mRmUrlY/Fw=";
    };
  };
  qq-amd64 = {
    pname = "qq-amd64";
