...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  LiteLoaderQQNT = {
    ...
    version = "54c549b3058aecc0d3ca14df5af36c1b4d1d12de";
    src = fetchFromGitHub {
      owner = "LiteLoaderQQNT";
      repo = "LiteLoaderQQNT";
      rev = "54c549b3058aecc0d3ca14df5af36c1b4d1d12de";
      fetchSubmodules = true;
      hash = "sha256-5OoGdYvnUGdU+D7DCPBE/iyQxL84fmKvXcuZ0EDkpBE=";
    };
    date = "2025-09-07";
  };
  MC-LauncherX-JSON = {
  ...
  OpenFreebuds = {
    pname = "OpenFreebuds";
    version = "72b39d03225d60d4f1f46a99990d812301449b0e";
    src = fetchFromGitHub {
      owner = "melianmiko";
      repo = "OpenFreebuds";
      rev = "72b39d03225d60d4f1f46a99990d812301449b0e";
      fetchSubmodules = true;
      hash = "sha256-hRj6ocALNe5pQTL4HJYS3u1tD4j1nxD56mst19wFVgI=";
    };
    date = "2025-08-01";
  };
  PiliPalaX = {
    pname = "PiliPalaX";
    version = "f0f52246777f2640025048f561e908cf1d3c3ead";
    src = fetchFromGitHub {
      owner = "bggRGjQaUbCoE";
      repo = "PiliPlus";
  ...
  alipan-version = {
    ...
    src = fetchurl {
      ...
      hash = "sha256-QK8seJrrDPLl42W2VklANL6eIShWaKHqyVjXOCqhtMc=";
    };
  };
  amule-dlp = {
    pname = "amule-dlp";
  ...
  baidupcs-go = {
    pname = "baidupcs-go";
    version = "f4c2138fe283e329e5a7d97754767ed4ea5796ef";
    src = fetchFromGitHub {
      owner = "qjfoidnh";
      repo = "BaiduPCS-Go";
      rev = "f4c2138fe283e329e5a7d97754767ed4ea5796ef";
      hash = "sha256-kapG5yaj+bY8XOgNRa9eV9XKLYt1YE+bSxET5w0orCg=";
    };
    date = "2025-09-02";
  };
  baidupcs-go-stable = {
  ...
  bird-lg-go = {
    ...
    src = fetchFromGitHub {
      ...
      repo = "bird-lg-go";
      tag = "v1.3.10";
      hash = "sha256-PIdy0hypwhPBmtn2GtptRNhACfNj8QLzEQA1onJ/v9k=";
    };
  };
  boringssl-oqs = {
    pname = "boringssl-oqs";
  ...
  cachyos-kernel = {
    ...
    version = "6d2e1307c21e0a6ffaebe0de8d7dfabe7703dd7e";
    src = fetchFromGitHub {
      owner = "CachyOS";
      repo = "linux-cachyos";
      rev = "6d2e1307c21e0a6ffaebe0de8d7dfabe7703dd7e";
      hash = "sha256-5MPUGxhtBRw2Cb/GeDtCc/LThmXmlDDW2HjMDqnt/04=";
    };
    date = "2025-09-09";
  };
  cachyos-kernel-patches = {
    pname = "cachyos-kernel-patches";
    version = "a6659635a7ec2426b8f7ef280e9a405a2325f556";
    src = fetchFromGitHub {
      owner = "CachyOS";
      repo = "kernel-patches";
      rev = "a6659635a7ec2426b8f7ef280e9a405a2325f556";
      hash = "sha256-ufBmabLtq3gSt0cPzHZ0pVm6O9G7GIQU1LUci/2yZ6M=";
    };
    date = "2025-09-09";
  };
  calibre-cops = {
  ...
  escrcpy_appimage = {
    ...
    version = "1.32.1";
    src = fetchurl {
      url = "https://github.com/viarotel-org/escrcpy/releases/download/v1.32.1/Escrcpy-1.32.1-linux-x86_64.AppImage";
      hash = "sha256-lyOHhtHZSVwbRXebb+F9Px+UiKgqz35GwWV/bSuIf3I=";
    };
  };
  etherguard = {
    pname = "etherguard";
  ...
  flutter_server_box_appimage = {
    ...
    version = "v1.0.1253/ServerBox_1253_amd64.AppImage";
    src = fetchurl {
      url = "https://github.com/lollipopkit/flutter_server_box/releases/download/v1.0.1253/ServerBox_1253_amd64.AppImage";
      hash = "sha256-VHrNW9RcuzQJ/vlPFEWzFPDDN7Y5497mFYd6pHU8VLk=";
    };
  };
  fr24feed-amd64 = {
  ...
  funasr = {
    pname = "funasr";
    version = "c0b2079fb1ef40b9ea1d67353335b0ebd7e31d5f";
    src = fetchFromGitHub {
      owner = "modelscope";
      repo = "FunASR";
      rev = "c0b2079fb1ef40b9ea1d67353335b0ebd7e31d5f";
      hash = "sha256-18eDijd2ISYOCUV2h3VTirdeuFDBF7KJtZ0wNTvGcSg=";
    };
    date = "2025-09-09";
  };
  geolite2-asn = {
  ...
  hdrop = {
    ...
    src = fetchFromGitHub {
      owner = "Schweber";
      repo = "hdrop";
      rev = "38fde78a70b28fe57585e8b5de1bb375efa38a7c";
      fetchSubmodules = true;
      hash = "sha256-TvGcK1D9V/hCUR9B7HavjuvcNSSy+tY8Y+inaj2Vtvk=";
    };
    date = "2025-07-01";
  };
  helium-gateway-rs = {
  ...
  i915-sriov-dkms = {
    ...
    version = "518611bcacfb0493a178e23acae071814baa4572";
    src = fetchFromGitHub {
      owner = "strongtz";
      repo = "i915-sriov-dkms";
      rev = "518611bcacfb0493a178e23acae071814baa4572";
      hash = "sha256-SEFhn3fRKAVI2zNTS43zsKI9VWhDK+8oU5zODHsZh24=";
    };
    date = "2025-08-30";
  };
  igsc = {
  ...
  kikoplay-script = {
    ...
    version = "706f19f681ef5e2c4a6a8a25ea9de8c911b623ae";
    src = fetchFromGitHub {
      owner = "KikoPlayProject";
      repo = "KikoPlayScript";
      rev = "706f19f681ef5e2c4a6a8a25ea9de8c911b623ae";
      hash = "sha256-9CewMHbEdb0pVAnac0QuJz1Ty53pNx/PlHnGzydbiUM=";
    };
    date = "2025-08-30";
  };
  konnect = {
  ...
  kui = {
    ...
    src = fetchFromGitHub {
      ...
      repo = "kui";
      tag = "v1.13.0";
      hash = "sha256-rD7y2IpJCBbgXF2xeSPN+aPUH9OcTjmqn6+g4qYx6LM=";
    };
  };
  ldap-auth-proxy = {
  ...
  llama-cpp = {
    ...
    src = fetchFromGitHub {
      ...
      repo = "llama.cpp";
      tag = "b6435";
      hash = "sha256-Blvb01S0ZFqAR/sWeZ0trr396/Y4lrPKnjB7qmgcbyE=";
    };
  };
  loralib = {
    pname = "loralib";
  ...
  nginx-njs = {
    ...
    src = fetchFromGitHub {
      ...
      repo = "njs";
      tag = "0.9.1";
      hash = "sha256-AMHxKgvslBhe9TcAxW8IcZhUfweSwWvhQIv4UHMMo8o=";
    };
  };
  ngx_brotli = {
    pname = "ngx_brotli";
  ...
  peerbanhelper = {
    ...
    version = "8.0.12";
    src = fetchurl {
      url = "https://github.com/Ghost-chu/PeerBanHelper/releases/download/v8.0.12/PeerBanHelper_8.0.12.zip";
  ...
  qemu-user-static-amd64 = {
    ...
    version = "10.1.0+ds-2";
    src = fetchurl {
      url = "http://ftp.debian.org/debian/pool/main/q/qemu/qemu-user_10.1.0+ds-2_amd64.deb";
      name = "qemu.deb";
      hash = "sha256-AM4F/YWgvKCR2N5Vcbwp4IGT4MQl4MMFMWnsg1q2jys=";
    };
  };
  qemu-user-static-arm64 = {
    ...
    version = "10.1.0+ds-2";
    src = fetchurl {
      url = "http://ftp.debian.org/debian/pool/main/q/qemu/qemu-user_10.1.0+ds-2_arm64.deb";
      name = "qemu.deb";
      hash = "sha256-cNyhxBr1hFJPoj7YCYXkYNTby2WOEdiWNCch9Sld5oo=";
    };
  };
  qemu-user-static-armhf = {
    ...
    version = "10.1.0+ds-2";
    src = fetchurl {
      url = "http://ftp.debian.org/debian/pool/main/q/qemu/qemu-user_10.1.0+ds-2_armhf.deb";
      name = "qemu.deb";
      hash = "sha256-/A3XFaKCwfr7jw6EueqiKS9DvMWD5xuEuCTsaq/eSuE=";
    };
  };
  qemu-user-static-i386 = {
    ...
    version = "10.1.0+ds-2";
    src = fetchurl {
      url = "http://ftp.debian.org/debian/pool/main/q/qemu/qemu-user_10.1.0+ds-2_i386.deb";
      name = "qemu.deb";
      hash = "sha256-ZZg9kj37BXR3zmQL2lncfvL6KpNflY6EgvOfAacEFLs=";
    };
  };
  qhttpengine = {
    pname = "qhttpengine";
  ...
  qsp = {
    pname = "qsp";
    version = "2228924f8cb3ce0ef2b9ae35c91c34a96d2f4c2c";
    src = fetchFromGitHub {
      owner = "QSPFoundation";
      repo = "qspgui";
      rev = "2228924f8cb3ce0ef2b9ae35c91c34a96d2f4c2c";
      hash = "sha256-G37reIydTWUNlprqo6dqSKK0H4wIimsUcjiZOk3UyjI=";
    };
    date = "2025-09-06";
  };
  qsp-lib = {
  ...
  rime-ice = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-V/4/T04a/Q234RoodGCopfbFoiHsS9fIkblz3q3YkBw=";
    };
    date = "2025-09-10";
  };
  rime-moegirl = {
  ...
  rwkv = {
    ...
    version = "0.8.30";
    src = fetchurl {
      url = "https://pypi.org/packages/source/r/rwkv/rwkv-0.8.30.tar.gz";
      hash = "sha256-5wVhjRdkqJHFPstLNGOmIeu5mvC00xZVPmTEXOs2NLM=";
    };
  };
  ...
  snell-server-aarch32-linux = {
    ...
    version = "v5.0.0";
    src = fetchurl {
      url = "https://dl.nssurge.com/snell/snell-server-v5.0.0-linux-armv7l.zip";
  ...
  snell-server-aarch64-linux = {
    ...
    version = "v5.0.0";
    src = fetchurl {
      url = "https://dl.nssurge.com/snell/snell-server-v5.0.0-linux-aarch64.zip";
      hash = "sha256-dnCQMqjRBD+m8B4fu7cnFI13U0qDKT1zVkpWksOWcpI=";
    };
  };
  snell-server-i686-linux = {
    ...
    version = "v5.0.0";
    src = fetchurl {
      url = "https://dl.nssurge.com/snell/snell-server-v5.0.0-linux-i386.zip";
      hash = "sha256-Hw+nIHS8FEXGgGYq+AgTvB9orxN3ptj0GTnI88r4nog=";
    };
  };
  snell-server-x86_64-linux = {
    ...
    src = fetchurl {
      ...
      hash = "sha256-iTp75PxeaVuXrLgK+aSpm5mGf4y0dnhHJaP4n6I5QOE=";
    };
  };
  soggy = {
    pname = "soggy";
  ...
  v2ray-rules-dat = {
    ...
    src = fetchurl {
      url = "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/download/202509092211/rules.zip";
      hash = "sha256-CG0GPBhNHYyfMq8v0JJPVQexBF91VUIhR/KPAJ9EPx8=";
    };
  };
  ...
  vector-quantize-pytorch = {
    ...
    src = fetchFromGitHub {
      ...
      tag = "1.23.2";
      hash = "sha256-V5MPHDj2DQHRc6qfK/6tjE0NXWSpzMsxK29kB3k65eM=";
    };
  };
  vgpu-unlock-rs = {
  ...
  wechat-web-devtools-linux_appimage = {
    ...
    src = fetchurl {
      url = "https://github.com/msojocs/wechat-web-devtools-linux/releases/download/v1.06.2504010-2/WeChat_Dev_Tools_v1.06.2504010-2_x86_64_linux.AppImage";
  ...
  wechat-web-devtools-linux_bin = {
    ...
    version = "1.06.2504010-2";
    src = fetchurl {
      url = "https://github.com/msojocs/wechat-web-devtools-linux/releases/download/v1.06.2504010-2/WeChat_Dev_Tools_v1.06.2504010-2_x86_64_linux.tar.gz";
      hash = "sha256-bOVt00wMfYqyzJV3w61bfWHGB7R30ChD/acUr6G7mnQ=";
    };
  };
  wine-wechat-x64 = {
