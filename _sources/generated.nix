...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  PiliPalaX = {
    pname = "PiliPalaX";
    version = "cf24f851e86246c4f7a74e6b2241dd00d6ad1570";
    src = fetchFromGitHub {
      owner = "bggRGjQaUbCoE";
      repo = "PiliPlus";
      rev = "cf24f851e86246c4f7a74e6b2241dd00d6ad1570";
      fetchSubmodules = true;
      hash = "sha256-HVhpUwrTw0VRg0TmfONjCt7E1oKl/gdRWaRnGL9fCvc=";
    };
    date = "2025-08-27";
  };
  SteamTools = {
  ...
  bilibili = {
    ...
    version = "v1.17.1-2";
    src = fetchurl {
      url = "https://github.com/msojocs/bilibili-linux/releases/download/v1.17.1-2/bilibili-asar-v1.17.1-2.tar.gz";
      hash = "sha256-A6eKhzr5Dgc27FTJPOGdnZQIyTCeunGBUjj3JN5nJCs=";
    };
  };
  bilibili-src = {
    pname = "bilibili-src";
    ...
    src = fetchFromGitHub {
      ...
      repo = "bilibili-linux";
      tag = "v1.17.1-2";
      hash = "sha256-ordjN3gz5JwRTLmcEDVdJhYg44UgQ18SY4Hi8OECCJQ=";
    };
  };
  bin-cpuflags-x86 = {
  ...
  llama-cpp = {
    ...
    src = fetchFromGitHub {
      ...
      repo = "llama.cpp";
      tag = "b6298";
      hash = "sha256-bMRZE8rcnVq/1njp6/+NrHEKSS02dcBa8mhoXMfvs0c=";
    };
  };
  loralib = {
    pname = "loralib";
  ...
  rime-ice = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-C6g/Rlsvx16kQr8jVl104SmYMBytvBo1fDU+j9d3tt4=";
    };
    date = "2025-08-27";
  };
  rime-moegirl = {
  ...
  v2ray-rules-dat = {
    ...
    src = fetchurl {
      url = "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/download/202508262213/rules.zip";
      hash = "sha256-hVuW5uADNiH0HsbBmMpmhTcW6Jw+HlBzNtvoOCtzn6c=";
    };
  };
