...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  cachyos-kernel = {
    ...
    version = "616810a6564ace452952ac658f24c57a46f89f86";
    src = fetchFromGitHub {
      owner = "CachyOS";
      repo = "linux-cachyos";
      rev = "616810a6564ace452952ac658f24c57a46f89f86";
      hash = "sha256-FZ/Ois+lTA77NJSwDQAx6gWzhDWobM7kY8sQPtTwsKA=";
    };
    date = "2025-02-10";
  };
  cachyos-kernel-patches = {
    pname = "cachyos-kernel-patches";
    version = "ccaba8306c3422f5bd69f355ee023ca04b8e1002";
    src = fetchFromGitHub {
      owner = "CachyOS";
      repo = "kernel-patches";
      rev = "ccaba8306c3422f5bd69f355ee023ca04b8e1002";
      hash = "sha256-4FC9XTo9/6wtO8blax/u54KektPJeZw3gm+HcpjXMmc=";
    };
    date = "2025-02-10";
  };
  calibre-cops = {
  ...
  liboqs-unstable = {
    ...
    version = "5afca642057faa54878cf6937b46fe6f00b45646";
    src = fetchFromGitHub {
      owner = "open-quantum-safe";
      repo = "liboqs";
      rev = "5afca642057faa54878cf6937b46fe6f00b45646";
      hash = "sha256-KWaPJ41dNaFT16C67TSQEWMZHtX8kKMktnsWgtdnkOg=";
    };
    date = "2025-02-10";
  };
  libqcef = {
  ...
  plasma-smart-video-wallpaper-reborn = {
    ...
    src = fetchFromGitHub {
      ...
      tag = "v1.1.0";
      hash = "sha256-9d4SQ3oCSI3PI0MAOe7AudQzeN4TEOMoGGPsxRfQM/U=";
    };
  };
  ...
  escrcpy_appimage = {
    ...
    version = "1.28.6";
    src = fetchurl {
      url = "https://github.com/viarotel-org/escrcpy/releases/download/v1.28.6/Escrcpy-1.28.6-linux-x86_64.AppImage";
      hash = "sha256-ttF23vXyJjUF7DifA/tJhcTCyOQjgDwEWWQFwApsb/g=";
    };
  };
  open-interpreter = {
  ...
  wechat-web-devtools-linux_appimage = {
    ...
    src = fetchurl {
      url = "https://github.com/msojocs/wechat-web-devtools-linux/releases/download/v1.06.2412040-1/WeChat_Dev_Tools_v1.06.2412040-1_x86_64_linux.AppImage";
      hash = "sha256-fyOJER8xp7o4dvjaXzJSvKsZYJEDbxR0cGMbvvn8Jc8=";
    };
  };
  wechat-web-devtools-linux_bin = {
    ...
    version = "1.06.2412040-1";
    src = fetchurl {
      url = "https://github.com/msojocs/wechat-web-devtools-linux/releases/download/v1.06.2412040-1/WeChat_Dev_Tools_v1.06.2412040-1_x86_64_linux.tar.gz";
      hash = "sha256-ONFO5DTbCHjA9XRhP/Ed3Akl7iStBK4YdBaem9sKVKY=";
    };
  };
}
