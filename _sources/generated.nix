...
}:
{
  ...
  PiliPalaX = {
    pname = "PiliPalaX";
    version = "a928e48159a109ef33707a59c4d7ea3c076baa83";
    src = fetchFromGitHub {
      owner = "bggRGjQaUbCoE";
      repo = "PiliPlus";
      rev = "a928e48159a109ef33707a59c4d7ea3c076baa83";
      fetchSubmodules = true;
      hash = "sha256-jIU/kw5pGS6MtJsfJOIIT6tyFXVk67r1hn3VhVeEcGg=";
    };
    date = "2025-10-03";
  };
  SteamTools = {
  ...
  cachyos-kernel-patches = {
    ...
    version = "6a7f079aadc930fa9195e36d54f4cb363d5d7d75";
    src = fetchFromGitHub {
      owner = "CachyOS";
      repo = "kernel-patches";
      rev = "6a7f079aadc930fa9195e36d54f4cb363d5d7d75";
      hash = "sha256-HPH+kUQBLAY+LUZOOsuB/z1njtQhOT0iUpvzrrunpDk=";
    };
    date = "2025-10-03";
  };
  calibre-cops = {
    ...
    version = "3.7.2";
    src = fetchurl {
      url = "https://github.com/mikespub-org/seblucas-cops/releases/download/3.7.2/cops-3.7.2-php82.zip";
      hash = "sha256-jk3oXiySmp84/HQih+b4R+3TcvAtZLf2A/pVG6RNBN0=";
    };
  };
  cef-binary = {
    pname = "cef-binary";
  ...
  dbip-asn-lite = {
    ...
    version = "2025-10";
    src = fetchurl {
      url = "https://download.db-ip.com/free/dbip-asn-lite-2025-10.mmdb.gz";
  ...
  dbip-country-lite = {
    ...
    version = "2025-10";
    src = fetchurl {
      url = "https://download.db-ip.com/free/dbip-country-lite-2025-10.mmdb.gz";
  ...
  geolite2-asn = {
    ...
    src = fetchurl {
      ...
      hash = "sha256-2BnSnv5/uPn0Zo7QMXMxlkEjrr7MVPpcUFT9nqn7TUM=";
    };
  };
  geolite2-city = {
    pname = "geolite2-city";
    ...
    src = fetchurl {
      ...
      hash = "sha256-LwbfHPUKUYNx8iJLnxdHeuOj/lWiBFa92nij3B1IUk8=";
    };
  };
  geolite2-country = {
    ...
    src = fetchurl {
      ...
      hash = "sha256-W4nSaEjTe/LL+FmJF8EQ9J03Wz1e7mwA6G7xtQ82pOA=";
    };
  };
  glauth = {
    pname = "glauth";
  ...
  kikoplay-script = {
    ...
    version = "602b9074c3594f2c1f4d65aa83d84f70dfec4740";
    src = fetchFromGitHub {
      owner = "KikoPlayProject";
      repo = "KikoPlayScript";
      rev = "602b9074c3594f2c1f4d65aa83d84f70dfec4740";
      hash = "sha256-ZI1GLC1dPOhxupezAisFx82qvRjMnptXoqutK9QqsYg=";
    };
    date = "2025-09-27";
  };
  konnect = {
  ...
  llama-cpp = {
    ...
    src = fetchFromGitHub {
      ...
      repo = "llama.cpp";
      tag = "b6683";
      hash = "sha256-co+OUjSIylS7ENdE6p1bdSIZ/yzxosWON6kuZ04yDXE=";
    };
  };
  loralib = {
    pname = "loralib";
  ...
  nginx-njs = {
    ...
    src = fetchFromGitHub {
      ...
      repo = "njs";
      tag = "0.9.2";
      hash = "sha256-wQk1eQvgylvhyN7B+eaYwOf9a8XOXjfrO7dYdoBWlBU=";
    };
  };
  ngx_brotli = {
    pname = "ngx_brotli";
  ...
  qsp = {
    pname = "qsp";
    version = "6b2403cbd0adca99eb4ea1e90680bfd892ea6495";
    src = fetchFromGitHub {
      owner = "QSPFoundation";
      repo = "qspgui";
      rev = "6b2403cbd0adca99eb4ea1e90680bfd892ea6495";
  ...
  rime-ice = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-3wmlaN6G/XCuKY2YeMBP08kmusAyhIPsZssx4b5H5dY=";
    };
    date = "2025-09-26";
  };
  rime-moegirl = {
  ...
  v2ray-rules-dat = {
    ...
    src = fetchurl {
      url = "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/download/202510022212/rules.zip";
      hash = "sha256-s4Ndqm+BBvlFISrsIewjX3rvaYiZpXlf5G2lRGawsB0=";
    };
  };
