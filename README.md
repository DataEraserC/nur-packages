...
|  | `bqqnt` | [qq](https://im.qq.com/linuxqq/index.html) | 3.2.15 | QQ for Linux |
...
|  | `funasr` | [funasr](https://www.funasr.com/) | 0-unstable-2025-02-18 | Fundamental End-to-End Speech Recognition Toolkit and Open Source SOTA Pretrained Models |
...
|  | `liboqs-unstable` | [liboqs](https://openquantumsafe.org) | 0-unstable-2025-02-21 | C library for prototyping and experimenting with quantum-resistant cryptography |
...
|  | `rime-ice` | [rime-ice](https://dvel.me/posts/rime-ice/) | 0-unstable-2025-02-20 | Rime 配置：雾凇拼音 | 长期维护的简体词库 |
...
|  | `uni-api` | [uni-api](https://github.com/yym68686/uni-api) | 0-unstable-2025-02-19 | Unifies the management of LLM APIs. Call multiple backend services through a unified API interface |
...
| `Broken` | `llqqnt` | qq | qq=3.2.15+llqqnt_rev=0-unstable-2025-02-19 |  |
...
|  | `lantianCustomized.llama-cpp` | [llama-cpp](https://github.com/ggerganov/llama.cpp/) | 4755 | Inference of Meta's LLaMA model (and others) in pure C/C++ |
...
|  | `python3Packages.funasr` | [funasr](https://www.funasr.com/) | 0-unstable-2025-02-18 | Fundamental End-to-End Speech Recognition Toolkit and Open Source SOTA Pretrained Models |
...
|  | `uncategorized.liboqs-unstable` | [liboqs](https://openquantumsafe.org) | 0-unstable-2025-02-21 | C library for prototyping and experimenting with quantum-resistant cryptography |
...
|  | `uncategorized.rime-ice` | [rime-ice](https://dvel.me/posts/rime-ice/) | 0-unstable-2025-02-20 | Rime 配置：雾凇拼音 | 长期维护的简体词库 |
...
|  | `uncategorized.uni-api` | [uni-api](https://github.com/yym68686/uni-api) | 0-unstable-2025-02-19 | Unifies the management of LLM APIs. Call multiple backend services through a unified API interface |
...
|  | `uncategorized-DataEraserC.bqqnt` | [qq](https://im.qq.com/linuxqq/index.html) | 3.2.15 | QQ for Linux |
