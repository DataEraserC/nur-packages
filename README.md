...
|  | `bilibili` | [bilibili](https://app.bilibili.com/) | 1.17.1-7 | Desktop client for Bilibili |
...
|  | `calibre-cops` | [calibre-cops](http://blog.slucas.fr/en/oss/calibre-opds-php-server) | 3.6.5 | Web-based light alternative to Calibre content server / Calibre2OPDS to serve ebooks |
...
|  | `peerbanhelper` | [peerbanhelper](https://github.com/Ghost-chu/PeerBanHelper) | 8.0.12 | Automatically bans unwanted, leeching, and anomalous BT clients, with support for custom rules for qBittorrent and Transmission |
...
|  | `piper-tts` | [piper-tts](https://github.com/OHF-Voice/piper1-gpl) | 1.3.0 | Python component for piper-tts |
...
|  | `qsp` | [qsp](https://github.com/QSPFoundation/qspgui) | 5.9.3-b1-unstable-2025-09-06 | Interactive Fiction development platform (GUI application) |
|  | `qsp-lib` | [qsp-lib](https://github.com/QSPFoundation/qsp) | 0-unstable-2025-09-14 | Interactive fiction development platform (Game Library) |
...
|  | `uni-api` | [uni-api](https://github.com/yym68686/uni-api) | 0-unstable-2025-09-17 | Unifies the management of LLM APIs across multiple backend services |
...
|  | `lantianCustomized.attic-telnyx-compatible` | [attic](https://github.com/zhaofengli/attic) | 0-unstable-2025-08-28 | Multi-tenant Nix Binary Cache |
...
<details>
<summary>Package set: python3Packages (34 packages)</summary>
...
|  | `python3Packages.piper-tts` | [piper-tts](https://github.com/OHF-Voice/piper1-gpl) | 1.3.0 | Python component for piper-tts |
...
|  | `uncategorized.bilibili` | [bilibili](https://app.bilibili.com/) | 1.17.1-7 | Desktop client for Bilibili |
...
|  | `uncategorized.calibre-cops` | [calibre-cops](http://blog.slucas.fr/en/oss/calibre-opds-php-server) | 3.6.5 | Web-based light alternative to Calibre content server / Calibre2OPDS to serve ebooks |
...
|  | `uncategorized.peerbanhelper` | [peerbanhelper](https://github.com/Ghost-chu/PeerBanHelper) | 8.0.12 | Automatically bans unwanted, leeching, and anomalous BT clients, with support for custom rules for qBittorrent and Transmission |
...
|  | `uncategorized.qsp` | [qsp](https://github.com/QSPFoundation/qspgui) | 5.9.3-b1-unstable-2025-09-06 | Interactive Fiction development platform (GUI application) |
|  | `uncategorized.qsp-lib` | [qsp-lib](https://github.com/QSPFoundation/qsp) | 0-unstable-2025-09-14 | Interactive fiction development platform (Game Library) |
...
|  | `uncategorized.uni-api` | [uni-api](https://github.com/yym68686/uni-api) | 0-unstable-2025-09-17 | Unifies the management of LLM APIs across multiple backend services |
