...
<details>
<summary>Package set: (Uncategorized) (231 packages)</summary>
...
|  | `bqqnt` | [qq](https://im.qq.com/linuxqq/index.html) | 3.2.17 | QQ for Linux |
...
|  | `funasr` | [funasr](https://www.funasr.com/) | 0-unstable-2025-04-22 | Fundamental End-to-End Speech Recognition Toolkit and Open Source SOTA Pretrained Models |
...
|  | `hdrop` | [hdrop](https://github.com/Schweber/hdrop) | 0-unstable-2025-04-17 | Emulate 'tdrop' in Hyprland (run, show and hide specific programs per keybind) |
...
|  | `liboqs-unstable` | [liboqs](https://openquantumsafe.org) | 0-unstable-2025-04-25 | C library for prototyping and experimenting with quantum-resistant cryptography |
...
|  | `peerbanhelper` | [peerbanhelper](https://github.com/Ghost-chu/PeerBanHelper) | 7.4.14 | 自动封禁不受欢迎、吸血和异常的 BT 客户端，并支持自定义规则。PeerId黑名单/UserAgent黑名单/IP CIDR/假进度检测/超量下载检测/主动探测 支持 qBittorrent/Transmission |
...
|  | `pterodactyl-wings` | [pterodactyl-wings](https://pterodactyl.io) | 1.11.13-unstable-2025-04-28 | Server control plane for Pterodactyl Panel |
...
|  | `qemu-user-static` | [qemu-user-static](http://www.qemu.org/) | 10.0.0+ds-1 | Generic and open source machine emulator and virtualizer |
...
|  | `rime-ice` | [rime-ice](https://dvel.me/posts/rime-ice/) | 0-unstable-2025-04-27 | Rime 配置：雾凇拼音 | 长期维护的简体词库 |
...
|  | `uni-api` | [uni-api](https://github.com/yym68686/uni-api) | 0-unstable-2025-04-30 | Unifies the management of LLM APIs. Call multiple backend services through a unified API interface |
...
| `Broken` | `PiliPalaX` | [PiliPalaX](https://github.com/bggRGjQaUbCoE/PiliPalaX) | 0-unstable-2025-05-07 | PiliPalaX |
...
| `Deprecated` | `glauth` | [glauth](https://github.com/glauth/glauth) | 2.4.0 | (DEPRECATED: glauth is available in nixpkgs by a different maintainer) Lightweight LDAP server for development, home use, or CI |
...
| `Broken` | `kui` | [kui](https://kui.aber.sh/) | 1.9.0 | Easy-to-use web framework |
| `Broken` | `llqqnt` | qq | qq=3.2.17+llqqnt_rev=0-unstable-2025-02-19 |  |
...
| `Broken` `x86_64-linux` | `piliplus` | [piliplus](https://github.com/bggRGjQaUbCoE/PiliPlus) | 1.1.3.33 | Third party Bilibili client built with Flutter |
...
|  | `lantianCustomized.llama-cpp` | [llama-cpp](https://github.com/ggml-org/llama.cpp) | 5226 | Inference of Meta's LLaMA model (and others) in pure C/C++ |
...
| State | Path | Name | Version | Description |
| ----- | ---- | ---- | ------- | ----------- |
|  | `lantianLinuxXanmod.lts-generic` | [linux-xanmod-lts-generic](https://www.kernel.org/) | 6.12.25-xanmod1 | Linux Xanmod Kernel with Lan Tian Modifications |
|  | `lantianLinuxXanmod.lts-generic-configfile` | linux-config | 6.12.25-xanmod1 |  |
|  | `lantianLinuxXanmod.lts-generic-lto` | [linux-xanmod-lts-generic-lto](https://www.kernel.org/) | 6.12.25-xanmod1 | Linux Xanmod Kernel with Lan Tian Modifications and Clang+ThinLTO |
|  | `lantianLinuxXanmod.lts-generic-lto-configfile` | linux-config | 6.12.25-xanmod1 |  |
...
|  | `lantianLinuxXanmod.v6_12-generic` | [linux-xanmod-v6_12-generic](https://www.kernel.org/) | 6.12.25-xanmod1 | Linux Xanmod Kernel with Lan Tian Modifications |
|  | `lantianLinuxXanmod.v6_12-generic-configfile` | linux-config | 6.12.25-xanmod1 |  |
|  | `lantianLinuxXanmod.v6_12-generic-lto` | [linux-xanmod-v6_12-generic-lto](https://www.kernel.org/) | 6.12.25-xanmod1 | Linux Xanmod Kernel with Lan Tian Modifications and Clang+ThinLTO |
|  | `lantianLinuxXanmod.v6_12-generic-lto-configfile` | linux-config | 6.12.25-xanmod1 |  |
...
|  | `python3Packages.funasr` | [funasr](https://www.funasr.com/) | 0-unstable-2025-04-22 | Fundamental End-to-End Speech Recognition Toolkit and Open Source SOTA Pretrained Models |
...
| `Broken` | `python3Packages.kui` | [kui](https://kui.aber.sh/) | 1.9.0 | Easy-to-use web framework |
</details>
...
|  | `uncategorized.liboqs-unstable` | [liboqs](https://openquantumsafe.org) | 0-unstable-2025-04-25 | C library for prototyping and experimenting with quantum-resistant cryptography |
...
|  | `uncategorized.mtranservercore-rs` | [mtranservercore-rs](https://github.com/LinguaSpark/server) | 0-unstable-2025-04-22 | Lightweight multilingual translation service based on Rust and Bergamot translation engine, compatible with multiple translation frontend APIs |
...
|  | `uncategorized.peerbanhelper` | [peerbanhelper](https://github.com/Ghost-chu/PeerBanHelper) | 7.4.14 | 自动封禁不受欢迎、吸血和异常的 BT 客户端，并支持自定义规则。PeerId黑名单/UserAgent黑名单/IP CIDR/假进度检测/超量下载检测/主动探测 支持 qBittorrent/Transmission |
...
|  | `uncategorized.pterodactyl-wings` | [pterodactyl-wings](https://pterodactyl.io) | 1.11.13-unstable-2025-04-28 | Server control plane for Pterodactyl Panel |
|  | `uncategorized.qemu-user-static` | [qemu-user-static](http://www.qemu.org/) | 10.0.0+ds-1 | Generic and open source machine emulator and virtualizer |
...
|  | `uncategorized.rime-ice` | [rime-ice](https://dvel.me/posts/rime-ice/) | 0-unstable-2025-04-27 | Rime 配置：雾凇拼音 | 长期维护的简体词库 |
...
|  | `uncategorized.uni-api` | [uni-api](https://github.com/yym68686/uni-api) | 0-unstable-2025-04-30 | Unifies the management of LLM APIs. Call multiple backend services through a unified API interface |
...
| `Broken` `x86_64-linux` | `uncategorized.piliplus` | [piliplus](https://github.com/bggRGjQaUbCoE/PiliPlus) | 1.1.3.33 | Third party Bilibili client built with Flutter |
...
<details>
<summary>Package set: uncategorized-DataEraserC (53 packages)</summary>
...
|  | `uncategorized-DataEraserC.bqqnt` | [qq](https://im.qq.com/linuxqq/index.html) | 3.2.17 | QQ for Linux |
...
| `Broken` | `uncategorized-DataEraserC.PiliPalaX` | [PiliPalaX](https://github.com/bggRGjQaUbCoE/PiliPalaX) | 0-unstable-2025-05-07 | PiliPalaX |
...
| `Broken` | `uncategorized-DataEraserC.llqqnt` | qq | qq=3.2.17+llqqnt_rev=0-unstable-2025-02-19 |  |
