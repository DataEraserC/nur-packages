...
<details>
<summary>Package set: (Uncategorized) (287 packages)</summary>
...
|  | `BongoCat` | [BongoCat](https://github.com/vladelaina/BongoCat) | 1.12.0 | Interactive desktop companion with real-time reactions to keyboard, mouse, and gamepad input |
...
| `x86_64-linux` | `aw88399-legion-audio-patch` | [aw88399-legion-audio-patch](https://github.com/nadimkobeissi/16iax10h-linux-sound-saga) | 0-unstable-2026-09-21 | Audio patches for aw88399 on Lenovo Legion laptops |
| `x86_64-linux` | `aw88399-legion-firmware` | [aw88399-legion-firmware](https://github.com/nadimkobeissi/16iax10h-linux-sound-saga) | 0-unstable-2026-09-21 | Firmware for aw88399 audio codec on Lenovo Legion laptops |
...
| `x86_64-linux` | `easy-cliproxyapi-bin` | [easy-cliproxyapi-bin](https://github.com/router-for-me/EasyCLIProxyAPI) | 0.3.0 | Desktop GUI for CLIProxyAPI that configures popular AI agents |
...
|  | `opencode2api` | [opencode2api](https://github.com/jasonxu114514/opencode2api) | 1.3.4 | OpenCode Zen and Zen Go API gateway with OpenAI and Anthropic compatibility, key pooling, and WebUI |
...
|  | `qq-bridge` | [qq-bridge](https://github.com/Derpyu520/qq-bridge) | 0.1.5 | QQ (SnowLuma OneBot v11) bridge for DeepSeek Harness agents |
|  | `qq-bridge-dsh` | [qq-bridge-dsh](https://github.com/Derpyu520/qq-bridge) | 0.1.5 | DSH bundle for qq-bridge: MCP servers and agent presets |
|  | `qq-bridge-unwrapped` | [qq-bridge-unwrapped](https://github.com/Derpyu520/qq-bridge) | 0.1.5 | QQ (SnowLuma OneBot v11) bridge for DeepSeek Harness agents (unwrapped) |
|  | `qq-mode-console` | [qq-mode-console](https://github.com/Derpyu520/qq-bridge) | 0.1.5 | DSH plugin: QQ bridge mode console for settings UI |
...
|  | `rime-ice` | [rime-ice](https://dvel.me/posts/rime-ice/) | 0-unstable-2026-09-19 | Rime 配置：雾凇拼音 | 长期维护的简体词库 |
...
| `x86_64-linux` | `kernel-modules.aw88399-legion-audio-patch` | [aw88399-legion-audio-patch](https://github.com/nadimkobeissi/16iax10h-linux-sound-saga) | 0-unstable-2026-09-21 | Audio patches for aw88399 on Lenovo Legion laptops |
| `x86_64-linux` | `kernel-modules.aw88399-legion-firmware` | [aw88399-legion-firmware](https://github.com/nadimkobeissi/16iax10h-linux-sound-saga) | 0-unstable-2026-09-21 | Firmware for aw88399 audio codec on Lenovo Legion laptops |
...
|  | `uncategorized.geolite2` | [geolite2](https://dev.maxmind.com/geoip/geoip2/geolite2/) | 2026.09.19 | MaxMind's GeoIP2 GeoLite2 Country, City, and ASN databases |
...
|  | `uncategorized.rime-ice` | [rime-ice](https://dvel.me/posts/rime-ice/) | 0-unstable-2026-09-19 | Rime 配置：雾凇拼音 | 长期维护的简体词库 |
...
<details>
<summary>Package set: uncategorized-DataEraserC (63 packages)</summary>
...
|  | `uncategorized-DataEraserC.BongoCat` | [BongoCat](https://github.com/vladelaina/BongoCat) | 1.12.0 | Interactive desktop companion with real-time reactions to keyboard, mouse, and gamepad input |
...
| `x86_64-linux` | `uncategorized-DataEraserC.easy-cliproxyapi-bin` | [easy-cliproxyapi-bin](https://github.com/router-for-me/EasyCLIProxyAPI) | 0.3.0 | Desktop GUI for CLIProxyAPI that configures popular AI agents |
...
|  | `uncategorized-DataEraserC.opencode2api` | [opencode2api](https://github.com/jasonxu114514/opencode2api) | 1.3.4 | OpenCode Zen and Zen Go API gateway with OpenAI and Anthropic compatibility, key pooling, and WebUI |
...
|  | `uncategorized-DataEraserC.qq-bridge` | [qq-bridge](https://github.com/Derpyu520/qq-bridge) | 0.1.5 | QQ (SnowLuma OneBot v11) bridge for DeepSeek Harness agents |
|  | `uncategorized-DataEraserC.qq-bridge-dsh` | [qq-bridge-dsh](https://github.com/Derpyu520/qq-bridge) | 0.1.5 | DSH bundle for qq-bridge: MCP servers and agent presets |
|  | `uncategorized-DataEraserC.qq-bridge-unwrapped` | [qq-bridge-unwrapped](https://github.com/Derpyu520/qq-bridge) | 0.1.5 | QQ (SnowLuma OneBot v11) bridge for DeepSeek Harness agents (unwrapped) |
|  | `uncategorized-DataEraserC.qq-mode-console` | [qq-mode-console](https://github.com/Derpyu520/qq-bridge) | 0.1.5 | DSH plugin: QQ bridge mode console for settings UI |
...
| `Broken` | `uncategorized-DataEraserC.scrcpy-mask-git` | [scrcpy-mask-git](https://github.com/AkiChase/scrcpy-mask) | 0.9.0-unstable-2026-09-21 | scrcpy-mask |
