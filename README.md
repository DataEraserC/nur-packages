...
<details>
<summary>Package set: (Uncategorized) (271 packages)</summary>
...
|  | `cliproxyapi` | [cliproxyapi](https://github.com/router-for-me/CLIProxyAPI) | 7.2.159 | Wrap Gemini CLI, Antigravity, ChatGPT Codex, Claude Code, Qwen Code, iFlow as an OpenAI/Gemini/Claude/Codex compatible API service |
...
|  | `uni-api` | [uni-api](https://github.com/yym68686/uni-api) | 1.7.273-unstable-2026-09-12 | Unifies the management of LLM APIs across multiple backend services |
...
|  | `uncategorized.cliproxyapi` | [cliproxyapi](https://github.com/router-for-me/CLIProxyAPI) | 7.2.159 | Wrap Gemini CLI, Antigravity, ChatGPT Codex, Claude Code, Qwen Code, iFlow as an OpenAI/Gemini/Claude/Codex compatible API service |
...
|  | `uncategorized.uni-api` | [uni-api](https://github.com/yym68686/uni-api) | 1.7.273-unstable-2026-09-12 | Unifies the management of LLM APIs across multiple backend services |
...
<details>
<summary>Package set: uncategorized-DataEraserC (50 packages)</summary>
