...
| `x86_64-linux` | `aw88399-legion-audio-patch` | [aw88399-legion-audio-patch](https://github.com/nadimkobeissi/16iax10h-linux-sound-saga) | 0-unstable-2026-09-18 | Audio patches for aw88399 on Lenovo Legion laptops |
| `x86_64-linux` | `aw88399-legion-firmware` | [aw88399-legion-firmware](https://github.com/nadimkobeissi/16iax10h-linux-sound-saga) | 0-unstable-2026-09-18 | Firmware for aw88399 audio codec on Lenovo Legion laptops |
...
|  | `funasr` | [funasr](https://www.funasr.com/) | 1.4.16-unstable-2026-09-18 | Fundamental End-to-End Speech Recognition Toolkit and Open Source SOTA Pretrained Models |
...
|  | `opencode2api` | [opencode2api](https://github.com/jasonxu114514/opencode2api) | 1.3.2 | OpenCode Zen and Zen Go API gateway with OpenAI and Anthropic compatibility, key pooling, and WebUI |
...
|  | `rime-ice` | [rime-ice](https://dvel.me/posts/rime-ice/) | 0-unstable-2026-09-18 | Rime 配置：雾凇拼音 | 长期维护的简体词库 |
...
|  | `uni-api` | [uni-api](https://github.com/yym68686/uni-api) | 1.7.276-unstable-2026-09-18 | Unifies the management of LLM APIs across multiple backend services |
...
| `x86_64-linux` | `kernel-modules.aw88399-legion-audio-patch` | [aw88399-legion-audio-patch](https://github.com/nadimkobeissi/16iax10h-linux-sound-saga) | 0-unstable-2026-09-18 | Audio patches for aw88399 on Lenovo Legion laptops |
| `x86_64-linux` | `kernel-modules.aw88399-legion-firmware` | [aw88399-legion-firmware](https://github.com/nadimkobeissi/16iax10h-linux-sound-saga) | 0-unstable-2026-09-18 | Firmware for aw88399 audio codec on Lenovo Legion laptops |
...
|  | `python3Packages.funasr` | [funasr](https://www.funasr.com/) | 1.4.16-unstable-2026-09-18 | Fundamental End-to-End Speech Recognition Toolkit and Open Source SOTA Pretrained Models |
...
|  | `uncategorized.rime-ice` | [rime-ice](https://dvel.me/posts/rime-ice/) | 0-unstable-2026-09-18 | Rime 配置：雾凇拼音 | 长期维护的简体词库 |
...
|  | `uncategorized.uni-api` | [uni-api](https://github.com/yym68686/uni-api) | 1.7.276-unstable-2026-09-18 | Unifies the management of LLM APIs across multiple backend services |
...
|  | `uncategorized-DataEraserC.opencode2api` | [opencode2api](https://github.com/jasonxu114514/opencode2api) | 1.3.2 | OpenCode Zen and Zen Go API gateway with OpenAI and Anthropic compatibility, key pooling, and WebUI |
